                ...
                <tbody>
                    <?php foreach ($hasil as $data) : ?>
                        <tr>
                            ...
                            <td><input type="hidden" class="form-control" name="id_operasional" value="<?php echo $data['operasional_id']; ?>" readonly=""></td>
                            <td><input type="hidden" class="form-control" name="id_coa[]" value="<?php echo $data['coa_id']; ?>" readonly=""></td>
